...
* Sie müssen Java 17 (für SnapCenter 6.2.1 und höher) installiert haben oder
* Java 11 (für SnapCenter 6.2 und früher) auf Ihrem Linux- oder AIX-Host.
+
...
Erforderliche Softwarepakete
 a| 
* Java 17 (Oracle oder OpenJDK) für SnapCenter 6.2.1 und höher oder
* Java 11 für SnapCenter 6.2 und älter
...
Erforderliche Softwarepakete
 a| 
* IBM Java 17 für SnapCenter 6.2.1 und höher oder
* IBM Java 11 für SnapCenter 6.2 und früher
