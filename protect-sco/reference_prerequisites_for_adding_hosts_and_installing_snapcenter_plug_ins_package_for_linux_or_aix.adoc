...
* Sie müssen Java 17 auf Ihrem Linux- oder AIX-Host installiert haben.
+
...
NOTE: Stellen Sie sicher, dass Sie auf dem Linux-Host ausschließlich die zertifizierte Edition von Java 17 installiert haben.
