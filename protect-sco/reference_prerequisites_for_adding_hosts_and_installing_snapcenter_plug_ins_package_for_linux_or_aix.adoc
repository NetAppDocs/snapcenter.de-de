...
* Sie müssen Java 17, Java 11 (nur für SnapCenter 6.2) auf Ihrem Linux- oder AIX-Host installiert haben.
+
...
NOTE: Stellen Sie sicher, dass Sie auf dem Linux-Host ausschließlich die zertifizierte Edition von Java 17 bzw. Java 11 (nur für SnapCenter 6.2) installiert haben.
...
Erforderliche Softwarepakete
 a| 
Java 17 (Oracle oder OpenJDK), Java 11 (nur für SnapCenter 6.2)
...
Erforderliche Softwarepakete
 a| 
IBM Java 17, IBM Java 11 (für SnapCenter 6.2 nur)
