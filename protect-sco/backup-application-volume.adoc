...
+
Sie können dann klicken image:../media/filter_icon.png["Filtersymbol"] , um den Filterbereich zu schließen.
...
NOTE: Sie können eine Richtlinie auch erstellen, indem Sie auf klicken image:../media/add_policy_from_resourcegroup.gif["Richtlinie hinzufügen"].
...
+
.. Klicken Sie in der Spalte Zeitpläne konfigurieren auf image:../media/add_policy_from_resourcegroup.gif["Richtlinie hinzufügen"] die Richtlinie, für die Sie einen Zeitplan konfigurieren möchten.
