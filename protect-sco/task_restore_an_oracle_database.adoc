...
** http://["Technischer Bericht 4591 zu Datenbanksicherheit, Recovery, Replizierung und DR"^]
** https://["Der Vorgang schlägt mit ORA-00308-Fehler fehl"^]
...
* https://["Oracle RAC One-Knoten-Datenbank wird zur Durchführung von SnapCenter-Operationen übersprungen"^]
* https://["Fehler beim Wiederherstellen von einem sekundären SnapMirror- oder SnapVault-Standort"^]
* https://["Wiederherstellung aus einem Backup einer verwaisten Inkarnation fehlgeschlagen"^]
