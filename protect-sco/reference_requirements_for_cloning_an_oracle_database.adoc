...
+
Informationen zum Bearbeiten des Parameters asm_diskstring finden Sie unter https://["So fügen Sie Datenträgerpfade zu asm_diskstring hinzu"^].
...
+
**** https://["Linux Host Utilities Installation and Setup Guide"^]
**** https://["AIX Host Utilities Installation and Setup Guide"^]
