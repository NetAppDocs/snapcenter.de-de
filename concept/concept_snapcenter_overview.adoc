...
** Daten auf primären und sekundären ONTAP FAS, AFF oder ASA Systemen, die auf lokalem StorageGRID Objekt-Storage gesichert sind (mithilfe der Cloud-Backup-Integration von NetApp BlueXP)
...
** Daten auf primären und sekundären ONTAP FAS-, AFF- oder ASA-Systemen, gesichert auf Objekt- und Archiv-Storage in der Cloud (mittels NetApp BlueXP Cloud Backup-Integration)
