...
NOTE: Nach dem Upgrade auf SnapCenter 6.2.1 (Server und Plug-ins) und ONTAP 9.17.1 ändert SnapCenter flache Konsistenzgruppen während der ersten geplanten Sicherung in hierarchische Konsistenzgruppen.
