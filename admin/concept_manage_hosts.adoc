...
. Klicken Sie auf image:../media/more_icon.gif["Weitere Symbole"]*Dienst starten* oder *Dienst neu starten*.
+
...
. Klicken Sie auf image:../media/more_icon.gif["Weitere Symbole"], und klicken Sie dann auf *Zeitplan unterbrechen*, um den Host für dieses Plug-in in den Wartungsmodus zu versetzen.
+
