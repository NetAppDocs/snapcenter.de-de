...
Alle Storage-Verbindungen zu ONTAP und ASA r2 Storage-Systemen werden standardmäßig über ZAPI hergestellt. REST API kann für ausgewählte ONTAP-Versionen aktiviert werden.
