...
* Java 17 (für SnapCenter 6.2.1 und höher) oder Java 11 (für SnapCenter 6.2 und früher) muss auf Ihrem Host installiert sein.
+
...
* Java 17 (für SnapCenter 6.2.1 und höher) oder Java 11 (für SnapCenter 6.2 und früher) muss auf Ihrem Windows-Host installiert sein.
+
