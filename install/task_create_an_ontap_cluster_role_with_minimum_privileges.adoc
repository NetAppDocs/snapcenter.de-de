...
NOTE: Ab SnapCenter 5.0 werden Cluster-Admin-Benutzer nur über REST-APIs unterstützt. Wenn Sie Rollen erstellen möchten, die nicht Cluster Admin verwenden, sollten Sie ZAPI verwenden.
