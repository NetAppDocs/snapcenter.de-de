...
. Loggen Sie sich auf der NetApp Support Site unter ein http://["mysupport.netapp.com"^].
...
+
Informationen zu den Cmdlets finden Sie unter https://["SnapCenter Software Cmdlet Referenzhandbuch"^].
