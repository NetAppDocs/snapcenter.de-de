...
summary: Sie sollten ONTAP-Clusterrollen für ASA r2-Systeme erstellen, damit Sie für Vorgänge in SnapCenter nicht die ONTAP-Administratorrolle verwenden müssen. 
---
