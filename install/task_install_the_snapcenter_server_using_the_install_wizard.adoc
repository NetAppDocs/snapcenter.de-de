...
+
Informationen zur Aktivierung finden Sie auf der Microsoft-Website https://["Windows Installer-Protokollierung"^].
...
. Laden Sie das Installationspaket für den SnapCenter Server von herunter https://["NetApp Support Website"^].
