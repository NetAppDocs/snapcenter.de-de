...
Optional können Sie verschiedene Installations- und Konfigurationsvorgänge mithilfe von PowerShell-Cmdlets durchführen. Sie sollten PowerShell 7.4.13 oder höher verwenden.
...
** ASP.NET Core 10.0.7 Hosting Bundle (oder höher) In der link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter Software-Versionshinweise"^] finden sich die neuesten qualifizierten Versionen von ASP.NET Core für Ihre spezifische SnapCenter Version.
...
+
** TCP-Aktivierung
** HTTP-Aktivierung Siehe link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter Software-Versionshinweise"^] für die neuesten qualifizierten Versionen von ASP.NET Core für Ihre spezifische SnapCenter Version.
