...
NOTE: Ab 5.0 werden vServer Admin-Benutzer nur noch mit REST-APIs unterstützt. Wenn Sie Rollen erstellen möchten, die nicht vserver admin verwenden, sollten Sie ZAPI verwenden.
