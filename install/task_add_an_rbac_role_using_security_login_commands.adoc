...
Um die Konfiguration dieser Rollen auf Storage-Systemen zu vereinfachen, können Sie das Tool RBAC User Creator for NetApp ONTAP verwenden, das im NetApp Communities Forum bereitgestellt wird.
