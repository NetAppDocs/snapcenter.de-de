...
IMPORTANT: Wenn Sie beispielsweise SnapCenter Version 4.7 verwenden und auf 5.0 aktualisieren möchten, sollten Sie zuerst auf 4.8 aktualisieren und dann ein Rolling Upgrade auf 5.0 durchführen.
