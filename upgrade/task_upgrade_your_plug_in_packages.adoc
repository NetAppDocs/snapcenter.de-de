...
* Es muss sichergestellt sein, dass ASP.NET Core Runtime 10.0.7 Hosting Bundle (oder höher) und PowerShell 7.6.1 (oder höher) auf dem Windows Plug-in Host installiert sind.
+
...
* Es muss sichergestellt sein, dass Java 17 (Oracle Java, OpenJDK oder SAP JDK) für SnapCenter 6.2.1 und höher oder Java 11 für SnapCenter 6.2 und früher auf Windows- und Linux-Plug-in-Hosts installiert ist.
