...
* Stellen Sie sicher, dass PowerShell 7.4.13 auf dem Windows-Plug-in-Host installiert ist.
* Stellen Sie sicher, dass Java 17 (Oracle Java oder OpenJDK) auf Windows- und Linux-Plug-in-Hosts installiert ist (oder Java 11 nur für SnapCenter 6.2).
