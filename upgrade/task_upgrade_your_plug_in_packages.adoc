...
* Stellen Sie sicher, dass das ASP.NET Core Runtime 8.0.24 (und alle nachfolgenden 8.0.x-Patches) Hosting Bundle und PowerShell 7.4.13 oder höher auf dem Windows-Plug-in-Host installiert sind.
* Stellen Sie sicher, dass Java 17 (Oracle Java oder OpenJDK) für SnapCenter 6.2.1 und höher oder Java 11 für SnapCenter 6.2 und niedriger auf Windows- und Linux-Plug-in-Hosts installiert ist.
