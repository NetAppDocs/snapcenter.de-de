...
. Wählen Sie auf der Seite Ressourcen *IBM DB2 Resource hinzufügen* aus.
...
Mount-Pfade
 a| 
Geben Sie die Mount-Pfade an, unter denen die Ressource eingebunden ist. Dies gilt nur für Windows-Hosts.
...
. Optional: Auf der Seite „Ressourceneinstellungen“ können Sie für Ressourcen auf Linux-Hosts, auf denen das SnapCenter Plug-in für IBM Db2 installiert ist, benutzerdefinierte Schlüssel-Wert-Paare für das IBM Db2 Plug-in eingeben. Benutzerdefinierte Schlüssel-Wert-Paare werden für IBM Db2-Datenbanken, die als zentrales Windows-Plug-in registriert sind, nicht unterstützt.
