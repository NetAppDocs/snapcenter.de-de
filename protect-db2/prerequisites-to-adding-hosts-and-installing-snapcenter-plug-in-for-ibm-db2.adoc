...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["JAVA für Windows herunterladen"^]
...
* Sie müssen die passwortbasierte SSH-Verbindung für den Root- oder nicht-Root-Benutzer aktiviert haben.
* Sie müssen Java 11 auf Ihren Linux- oder AIX-Hosts installiert haben.
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Laden Sie JAVA für Linux herunter"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["Laden Sie JAVA für AIX herunter"^]
