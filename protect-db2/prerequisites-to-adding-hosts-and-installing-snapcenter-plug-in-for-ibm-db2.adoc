...
* Sie müssen die passwortbasierte SSH-Verbindung für den Root- oder nicht-Root-Benutzer aktiviert haben.
* Java 17 (Oracle Java, OpenJDK oder SAP JDK) für SnapCenter 6.2.1 und höher oder Java 11 für SnapCenter 6.2 und früher muss auf Ihren Linux- oder AIX-Hosts installiert sein.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Java für Linux herunterladen"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["Java für AIX herunterladen"^]
