...
+
link:../protect-db2/task_configure_gMSA_on_windows_server_2012_or_later.html["Konfigurieren Sie das Group Managed Service-Konto unter Windows Server 2016 oder höher für IBM DB2"^]
