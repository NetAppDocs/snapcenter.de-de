...
. Geben Sie auf der Seite Aufbewahrung und Sicherung die Aufbewahrungseinstellungen für den Sicherungstyp und den auf der Seite Sicherungstyp ausgewählten Zeitplantyp an:
