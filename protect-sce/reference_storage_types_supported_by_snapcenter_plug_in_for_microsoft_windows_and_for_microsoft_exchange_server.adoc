...
---
= Vom SnapCenter -Plug-in für Microsoft Exchange Server unterstützte Speichertypen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
SnapCenter -Bereitstellungs- und Datenschutzunterstützung ist auf Windows Server verfügbar. Die neuesten Informationen zu unterstützten Versionen finden Sie im https://imt.netapp.com/imt/imt.jsp?components=180321;180339;180327;&solution=1257&isHWU&src=IMT["NetApp Interoperabilitäts-Matrix-Tool"^] .
