...
+
Sie können die Ressourcengruppe entweder durch Eingabe des Ressourcengruppennamens in das Suchfeld oder durch Klicken durchsuchen image:../media/filter_icon.png[""] Und das Tag auswählen. Sie können dann auf klicken image:../media/filter_icon.png[""] Um den Filterbereich zu schließen.
