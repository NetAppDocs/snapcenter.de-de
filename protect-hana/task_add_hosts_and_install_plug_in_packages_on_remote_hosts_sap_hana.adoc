...
+
link:../protect-hana/task_configure_gMSA_on_windows_server_2012_or_later.html["Konfiguration des Gruppenverwaltungsservice-Kontos unter Windows Server 2016 oder höher für SAP HANA"^]
