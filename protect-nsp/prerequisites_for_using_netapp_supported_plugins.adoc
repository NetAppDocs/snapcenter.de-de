...
* Installieren Sie gegebenenfalls Java 17 (Oracle Java oder OpenJDK) für SnapCenter 6.2.1 und höher oder
* Java 11 für SnapCenter 6.2 und früher auf dem Plug-in-Host.
