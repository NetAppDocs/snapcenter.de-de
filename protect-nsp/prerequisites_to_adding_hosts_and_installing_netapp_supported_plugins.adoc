...
* Sie müssen Java 17 auf Ihrem Linux-, Windows- oder AIX-Host installiert haben.
+
...
+
Wenn Sie Windows Server 2019 oder Windows Server 2016 für den SnapCenter Server-Host verwenden, müssen Sie Java 17 installieren.
