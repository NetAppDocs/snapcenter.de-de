...
* Sie müssen Java 17, Java 11 (nur für SnapCenter 6.2) auf Ihrem Linux-, Windows- oder AIX-Host installiert haben.
+
...
+
Wenn Sie Windows Server 2019 oder Windows Server 2016 für den SnapCenter Server-Host verwenden, müssen Sie Java 17, Java 11 (nur für SnapCenter 6.2) installieren.
...
Erforderliche Softwarepakete
 a| 
Java 17, Java 11 (nur für SnapCenter 6.2), IBM Java
