...
* Sie müssen Java 17 (Oracle Java oder OpenJDK) für SnapCenter 6.2.1 und höher installiert haben oder
* Java 11 für SnapCenter 6.2 und früher auf Ihrem Linux-, Windows- oder AIX-Host.
+
...
+
Wenn Sie Windows Server 2019 oder Windows Server 2016 für den SnapCenter Server-Host verwenden, müssen Sie Java 17 (Oracle Java oder OpenJDK) für SnapCenter 6.2.1 und höher oder Java 11 für SnapCenter 6.2 und früher installieren.
...
Erforderliche Softwarepakete
 a| 
* Java 17 für SnapCenter 6.2.1 und höher, IBM Java oder
* Java 11 für SnapCenter 6.2 und älter, IBM Java
