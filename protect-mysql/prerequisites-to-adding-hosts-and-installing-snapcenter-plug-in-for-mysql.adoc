...
* Java 17 (Oracle Java, OpenJDK oder SAP JDK) muss für SnapCenter 6.2.1 und höher oder Java 11 für SnapCenter 6.2 und früher auf Ihrem Host installiert sein.
+
...
* Wenn Sie eine MySQL-Version vor 8.0 verwenden, müssen Sie das MySQLX-Plugin manuell installieren und aktivieren. Ab MySQL 8.0 ist das MySQLX-Plugin standardmäßig installiert und aktiviert.
...
* Java 17 (Oracle Java, OpenJDK oder SAP JDK) für SnapCenter 6.2.1 und höher oder Java 11 für SnapCenter 6.2 und früher muss auf Ihrem Windows-Host installiert sein.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Laden Sie Java für alle Betriebssysteme herunter"]
...
Um einen zusätzlichen Befehl auf dem SnapCenter-Plugin für MySQL auszuführen, müssen Sie ihn in die Datei _allowed_commands.config_ einfügen.
