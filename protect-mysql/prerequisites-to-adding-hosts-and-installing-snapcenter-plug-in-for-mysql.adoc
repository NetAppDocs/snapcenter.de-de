...
* Sie müssen Java 17, Java 11 (nur für SnapCenter 6.2) auf Ihrem Host installiert haben.
+
...
* Sie müssen Java 17, Java 11 (nur für SnapCenter 6.2) auf Ihrem Windows-Host installiert haben.
+
