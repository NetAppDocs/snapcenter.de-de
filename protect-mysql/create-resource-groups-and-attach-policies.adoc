...
|===
+
image:../media/application_settings.gif["Anwendungseinstellung"]
...
NOTE: Die benutzerdefinierten Schlüssel-Wert-Paare werden für MySQL Linux-Plug-in-Systeme unterstützt und nicht für MySQL-Datenbanken unterstützt, die als zentralisiertes Windows-Plug-in registriert sind.
