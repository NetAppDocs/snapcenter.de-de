...
Für die Mindestanforderungen des ONTAP und Applikations-Plug-ins siehe https://["Interoperabilitäts-Matrix-Tool"^]
...
Betriebssystem (64 Bit)
 a| 
Siehe https://["Interoperabilitäts-Matrix-Tool"^]
...
Informationen zum unterstützten dynamischen Portbereich finden Sie unter https://["Serviceübersicht und Netzwerkanschlussanforderungen für Windows"^].
...
=== Laden Sie den SnapCenter-Server herunter, und installieren Sie ihn

*Schritte*

. Laden Sie das Installationspaket für den SnapCenter-Server von herunter https://["NetApp Support Website"^] Doppelklicken Sie anschließend auf die exe.
+
...
=== Fügen Sie eine Controller-basierte Lizenz für SnapCenter Standard hinzu
...
=== Fügen Sie eine kapazitätsbasierte SnapCenter Lizenz hinzu
...
=== Richten Sie Verbindungen zum Speichersystem ein
...
=== Richten Sie Run As Credentials ein, um das Plug-in für Microsoft SQL Server zu installieren
